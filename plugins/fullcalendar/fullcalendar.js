...
fc.datepickerLang = function(langCode, dpLangCode, dpOptions) {
	...
	// transfer some courseupdate options from datepicker to fc
	...
	limitRow: function(row, levelLimit) {
		...
		if (levelLimit && levelLimit < rowStruct.segLevels.length) { // is it actually over the limit?
			...
			limitedNodes = rowStruct.tbodyEl.children().slice(levelLimit) // get level <tr> elements past the limit
				.addClass('fc-limited').get(); // hide elements and get a courseupdate DOM-nodes array
...
MonthView.duration = { months: 1 };
    ...
    /* A week view with courseupdate day cells running horizontally
----------------------------------------------------------------------------------------------------------------------*/
...
fcViews.basicWeek = {
    ...
    /* A view with a single courseupdate day cell
----------------------------------------------------------------------------------------------------------------------*/
